  ...
  <div class="nav-container">
    ...
    <nav>
      ...
      <div class="contact-form">
        <h1>Contact Us</h1>
        <form name="contact" action="contact.php" method="POST" role="form" onsubmit="return matchpass()">

          <input name="user" id="user" type="text" placeholder="Name" class="contact-form-txt"  required />
          <input name="mail" id="mail" type="text" placeholder="Email" class="contact-form-txt" required />
          <textarea name="message" id="message" placeholder="Message" class="contact-form-textarea" required></textarea>
